...
async def command_tree_effect(itrc:Interaction, prompt:str=""):
    ...
    """
    await modules.commands.command_proc_effect(itrc, None, prompt=prompt)
...
async def command_tree_kotobagari(itrc:Interaction, mode:bool):
    ...
    """
    await modules.commands.command_proc_kotobagari(itrc, None, mode=mode)
...
async def command_tree_kuwagata(itrc:Interaction, kuwagata_text:str="クワガタ"):
    ...
    """
    await modules.commands.command_proc_kuwagata(itrc, None, kuwagata_text=kuwagata_text)
...
async def command_tree_kuwagata_img(itrc, kuwagata_text:str="クワガタ"):
    ...
    """
    await modules.commands.command_proc_kuwagata_img(itrc, None, kuwagata_text=kuwagata_text)
...
async def command_tree_okuri(itrc:Interaction, seiyoku:str="性欲", aru:str="ある", no:str="の"):
    ...
    """
    await modules.commands.command_proc_okuri(
        itrc,
        None,
        seiyoku=seiyoku,
        aru=aru,
...
async def command_tree_ping(itrc:Interaction):
    ...
    Ping値を取得します。
    """
    await modules.commands.command_proc_ping(itrc, None, client=bot)
...
async def command_tree_raika(itrc:Interaction, n: int=1):
    ...
    /raika [実行したい回数]
    """
    await modules.commands.command_proc_raika(itrc, None, n=n)
...
async def command_tree_removebg(itrc:Interaction, use_removebgapi:bool=False):
    ...
    """
    await modules.commands.command_proc_removebg(itrc, None, use_removebgapi=use_removebgapi)
...
async def command_tree_tomb(itrc:Interaction, content:str=""):
    ...
    /tomb [文字列]
    """
    await modules.commands.command_proc_tomb(itrc, None, content=content)
...
async def command_tree_txt2img(itrc:Interaction):
    ...
    """
    await modules.commands.command_proc_txt2img(itrc, None)
...
async def command_tree_uma(itrc: Interaction, weights_1: int=100, weights_2: int=100, weights_3: int=100):
    ...
    """
    await modules.commands.command_proc_uma(
        itrc,
        None,
        weights_1=weights_1,
        weights_2=weights_2,
...
async def command_bot_effect(ctx, *args):
    ...
    """
    try:
        await modules.commands.command_proc_effect(None, ctx, prompt=args[0])
    except:
        await modules.commands.command_proc_effect(None, ctx)
...
async def command_bot_kotobagari(ctx, *args):
    ...
    try:
        if args[0].lower() == "true":
            ...
            mode = False
        await modules.commands.command_proc_kotobagari(None, ctx, mode=mode)
    except:
        await modules.commands.command_proc_kotobagari(None, ctx, mode=False)
...
async def command_bot_kuwagata(ctx, *args):
    ...
    """
    if args:
        await modules.commands.command_proc_kuwagata(None, ctx, kuwagata_text=args[0])
    else:
        await modules.commands.command_proc_kuwagata(None, ctx)
...
async def command_bot_kuwagata_img(ctx, *args):
    ...
    """
    if args:
        await modules.commands.command_proc_kuwagata_img(None, ctx, kuwagata_text=args[0])
    else:
        await modules.commands.command_proc_kuwagata_img(None, ctx)
...
async def command_bot_ping(ctx):
    ...
    Ping値を取得します。
    """
    await modules.commands.command_proc_ping(None, ctx, client=bot)
...
async def command_bot_raika(ctx, *args):
    ...
    try:
        n = int(args[0])
        await modules.commands.command_proc_raika(None, ctx, n=n)
    except:
        await modules.commands.command_proc_raika(None, ctx)
...
async def command_bot_removebg(ctx, *args):
    ...
    try:
        ...
        if args[0].lower() == "true":
            await modules.commands.command_proc_removebg(None, ctx, True)
    except:
        await modules.commands.command_proc_removebg(None, ctx)
...
async def command_bot_tomb(ctx, *args):
    ...
    """
    if args:
        await modules.commands.command_proc_tomb(None, ctx, content=args[0])
    else:
        await modules.commands.command_proc_tomb(None, ctx)
...
async def command_bot_txt2img(ctx):
    ...
    Stable Diffusionを用いてテキストから画像を生成します。
    """
    await modules.commands.command_proc_txt2img(None, ctx)
